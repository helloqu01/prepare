import shortId from 'shortid';//더미데이터 만들 때 사용한다. 랜덤 id생성
...
export const initialState = {
  ...
  imagePaths: [],
  hasMorePosts: true,
  loadPostsLoading: false, //무한 스크롤 부분
  loadPostsDone: false,
  loadPostsError: null,
...
export const generateDummyPost = (number) => Array(number).fill().map(() => ({//무한스크롤
...
//액션명
export const LOAD_POSTS_REQUEST = 'LOAD_POSTS_REQUEST'; //화면을 로드하면 무한 스크롤
